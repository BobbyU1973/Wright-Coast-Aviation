      ...
      <section className="py-16">
        <div className="container-page grid gap-8 xl:grid-cols-[minmax(0,1fr)_360px]">
          ...
          >
            ...
            <button
              type="submit"
              className="focus-ring min-h-12 rounded-[8px] bg-[var(--book)] px-5 py-3 font-bold !text-black transition hover:bg-[var(--book-hover)]"
            >
              Send Inquiry
            </button>
          </form>
            ...
            <div className="overflow-hidden rounded-[8px] border border-[var(--line)] bg-white">
              ...
              <div className="p-4">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="focus-ring inline-flex min-h-11 w-full items-center justify-center rounded-[8px] bg-[var(--book)] px-4 py-2 text-sm font-bold !text-black hover:bg-[var(--book-hover)]"
                >
